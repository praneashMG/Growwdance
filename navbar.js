...
<header id="mainNavbar"
  class="fixed top-0 left-0 w-full z-50 bg-white text-[#4B0082] shadow-[0_4px_12px_rgba(0,0,0,0.25)] transition-all duration-300">
  ...
  <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
      ...
      <ul class="flex items-center gap-10 font-medium text-sm" id="navLinks">
        ...
        <li class="relative">
          ...
          <ul id="homeDropdownMenu"
            class="absolute left-0 mt-3 w-44 bg-white text-[#2E0854] rounded-xl shadow-xl hidden z-50">

            <li>
              <a href="index.html"
                class="block px-4 py-2 rounded-t-xl transition hover:bg-[#EBD9FF]">
                Home 1
              </a>
            </li>
            ...
            <li>
              <a href="home2.html"
                class="block px-4 py-2 rounded-b-xl transition hover:bg-[#EBD9FF]">
                Home 2
              </a>
            </li>
        ...
        <li class="relative">
          ...
          <ul id="dashboardDropdownMenu"
            class="absolute left-0 mt-3 w-40 bg-white text-[#2E0854] rounded-xl shadow-xl hidden z-50">

            <li>
              <a href="user.html"
                class="block px-4 py-2 hover:bg-[#EBD9FF] rounded-t-xl transition">
                User
              </a>
            </li>
            ...
            <li>
              <a href="admin.html"
                class="block px-4 py-2 hover:bg-[#EBD9FF] rounded-b-xl transition">
                Admin
              </a>
            </li>
    ...
    <div id="rightButtons" class="hidden lg:flex items-center gap-8">
      ...
      <div class="relative">
        ...
        <ul id="profileMenu"
          class="absolute right-0 mt-3 w-44 bg-white text-[#2E0854] rounded-xl shadow-xl hidden z-50">
    ...
    <button id="hamburgerBtn"
      class="lg:hidden text-3xl text-[#EBD9FF] hover:text-[#C8A2FF] transition">
...
<!-- Mobile Menu -->
<div id="mobileMenu"
  class="fixed top-0 right-0 h-full w-72 bg-[#2E0854] text-[#E5E7EB] z-50
         transform translate-x-full transition-transform duration-300 lg:hidden shadow-2xl">

  <!-- Header -->
  <div class="flex items-center justify-between p-5 border-b border-[#4B0082]">
    <h2 class="text-xl font-bold text-[#C8A2FF]">Menu</h2>
    <button id="closeMenuBtn" class="text-3xl hover:text-[#EBD9FF] transition">
    ...
    <ul class="space-y-4">
      ...
      <li>
        <button id="mobileDropdownBtn"
          class="w-full flex items-center justify-between py-2 hover:text-[#C8A2FF] transition">
          <span>Home</span>
        ...
        <ul id="mobileDropdownMenu" class="hidden mt-2 ml-4 space-y-2">
          <li><a href="index.html" class="block py-1 hover:text-[#EBD9FF]">Home 1</a></li>
          <li><a href="home2.html" class="block py-1 hover:text-[#EBD9FF]">Home 2</a></li>
        </ul>
      </li>

      <li><a href="about.html" class="block py-2 hover:text-[#C8A2FF] transition">About</a></li>
      <li><a href="blog.html" class="block py-2 hover:text-[#C8A2FF] transition">Blog</a></li>
      <li><a href="class.html" class="block py-2 hover:text-[#C8A2FF] transition">Classes</a></li>
      <li><a href="gallery.html" class="block py-2 hover:text-[#C8A2FF] transition">Gallery</a></li>
      <li><a href="contact.html" class="block py-2 hover:text-[#C8A2FF] transition">Contact</a></li>
      ...
      <li>
        ...
        <ul id="mobileDashboardMenu" class="hidden mt-2 ml-4 space-y-2">
          <li><a href="user.html" class="block py-1 hover:text-[#EBD9FF]">User</a></li>
          <li><a href="admin.html" class="block py-1 hover:text-[#EBD9FF]">Admin</a></li>
        </ul>
      </li>

      <!-- Mobile Extras -->
      <li class="pt-6 border-t border-[#4B0082] flex justify-around">

        <button id="mobile-theme-toggle" 
          class="text-2xl hover:text-[#C8A2FF] transition">
          <i class="bi bi-moon-fill"></i>
        </button>
